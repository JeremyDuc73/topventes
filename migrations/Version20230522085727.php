 ...
 */
final class Version20230522085727 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE review (id INT NOT NULL, author_id INT NOT NULL, content TEXT NOT NULL, PRIMARY KEY(id))');
